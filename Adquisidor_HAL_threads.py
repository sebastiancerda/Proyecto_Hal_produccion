    ...
    def adquisidor_serial(self):
        while True:
            ...
            try:
                ...
                '''
                Timers para tarea socket, inicia la tarea con la variable globales ip y port
                '''
...
if __name__ == '__main__':
    ...
    logging.basicConfig(filename=filename, format='%(asctime)s %(message)s', datefmt='%m/%d/%Y %I:%M:%S %p',
                        level=logging.DEBUG)
